...
export default function RekapPage() {
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 text-center">Rekap Presensi</h1>
      </div>
        ...
        <form onSubmit={handleLoadRekap} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                placeholder="Semua kelas (All)"
              />
              <p className="text-xs text-gray-500 mt-1">Kosongkan atau isi "All" untuk semua kelas</p>
            </div>
          </div>
          ...
          <div className="flex space-x-4">
            ...
            <button
              ...
              className="bg-green-500 text-white px-6 py-3 rounded-lg font-semibold hover:bg-green-700 transition disabled:bg-green-300 disabled:cursor-not-allowed"
            >
